...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-11-2020 a las 19:51:13
...
(1, '49189516', 'Xavier', 'Jaramillo', 'Vives', '1999-11-17', 'xavijvives@gmail.com', 'Home');
...
--
ALTER TABLE `tbl_inscripcio`
  MODIFY `dorsal_participant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `tbl_participant`
--
ALTER TABLE `tbl_participant`
  MODIFY `id_participant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
